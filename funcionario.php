<?php 
  ...
  if (!empty($_GET['idAlt'])) {
    ...
    // echo "Carregado pessoa: ".$dadosAlt['nome'] //testando o funcionamento, ['nomd'] pode ser alterado para outras informações como celular, email, nome;
                ...
                <div class="row">
                    ...
                    <h3>Cadastro</h3>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              <label> Celular </label>
                              <input value="<?php echo isset($dadosAlt) ? $dadosAlt['celular'] : '' ?>" name="celular" type="text" class="form-control" placeholder="celular" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <label> Número </label>
                              <input value="<?php echo isset($dadosAlt) ? $dadosAlt['numero'] : '' ?>" name="numero" type="text" class="form-control" placeholder="numero" required>
                            </div>
                            <div class="form-group">
                              <label> Bairro </label>
                            ...
                            <div class="form-group">
                              <label> Email </label>
                              <input value="<?php echo isset($dadosAlt) ? $dadosAlt['email'] : '' ?>" name="email" type="text" class="form-control" placeholder="email" required>
                            </div>
                            <div class="form-group">
                              <label> Cargo </label>
                        ...
                        <table class="table" id="tabela">
                            ...
                            <tbody>
                              ...
                              <?php
                                ...
                                // em $coluna tem as seguintes informações(id, nome, cpf, celular)
