          ...
          <div class="col-md card">
            ...
            <form action="<?= $destino ?>" method="post">
              <div class="form-group">
                <label> ID </label>
                <input value="<?php echo isset($dadosAlt) ? $dadosAlt['id'] : '' ?>" name="id" class="form-control"
                  placeholder="Seu id" readonly>
              </div>
              <div class="form-group">
                <label> Cidade </label>
                <input value="<?php echo isset($dadosAlt) ? $dadosAlt['nome'] : '' ?>" name="nome" type="text"
                  class="form-control" placeholder="Sua cidade" required>
              </div>
              <div class="form-group">
                <label> Estado </label>
                <input value="<?php echo isset($dadosAlt) ? $dadosAlt['estado'] : '' ?>" name="estado" type="text"
                  class="form-control " placeholder="seu estado" required>
              </div>
              <div class="form-group">
                <label> CEP </label>
                <input value="<?php echo isset($dadosAlt) ? $dadosAlt['cep'] : '' ?>" name="cep" type="text"
                  class="form-control cpf" placeholder="Cep" required>
              </div>
              ...
              <tbody>
                ...
                while ($colunas = mysqli_fetch_assoc($resultado)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="cidade.php?idAlt=<?= $colunas['id'] ?>"><i
                          class="fa-regular fa-pen-to-square mr-10"></i></a>
                      <a href="<?php echo './cidade/excluir.php?id=' . $colunas['id'] ?>"><i class="fa-regular fa-trash-can"
                          style="color: #f21818;"></i></a>
                    </td>
                  </tr>
